...
subtitle:"Bike Sharing Demand – Projekt-Leitfaden"
...
Deiner Kreativität und deinen Design-Skills sind mit diesem $ggplot2$ keine Grenzen gesetzt. Ein Bespiel, wie man die einfachen Plots anpassen kann, ist diese Visualisierung von dem Zusammenhang zwischen der Nachfrage nach Leihrädern nach Tageszeit sowie der Außentemperatur. Aber keine Angst, solch ein detaillierter Plot wird nicht von dir erwartet. Es soll nur zeigen, zu welchen Visualisierungen $ggplot2()$ in der Lage ist.   
